...
public:
	...
	bool Blit2(SDL_Texture* texture, GB_Rectangle<int> destinationRectangle, const GB_Rectangle<int>* section = nullptr, float speed = 1.0f, double angle = 0, int pivotX = INT_MAX, int pivotY = INT_MAX) const;
